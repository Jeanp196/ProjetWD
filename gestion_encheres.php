...
// Sélectionner toutes les enchères en cours
$sql = "SELECT * FROM encheres_en_cours WHERE date_fin > NOW()";
$result = $conn->query($sql);

while ($row = $result->fetch_assoc()) {
    $id_item = $row['id_item'];

    // Sélectionner l'enchère automatique la plus élevée pour cet article
